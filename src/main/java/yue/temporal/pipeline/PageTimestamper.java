...
public class PageTimestamper {
	...
	public static void timestampFolder (String folderPath_TargetPage, String rootFolderPath_HistoricalPage, String folderPath_TaggedPage, int threshold_Length, double threshold_Similarity) throws NoSuchAlgorithmException, IOException {
	...
	public static TargetPage timestampFile (String filePath_TargetPage, String rootFolderPath_HistoricalPage, String folderPath_TaggedPage, int threshold_Length, double threshold_Similarity) throws NoSuchAlgorithmException, IOException {
    	//	1.	get the file of target pages
    	//	String filePath_TargetPage = args[0];
    	File file_TargetPage = new File(filePath_TargetPage);
    	//	TO MAKE SURE THE FILE IS THE CLUEWEB PAGE WE NEED
    	if (!CluewebFileProcess.isCluewebFile(file_TargetPage))
    		return null;
    	...
    	//	3. 	process the file of the target page
		//	3.0	output the signal to screen
    	...
    	//File folder_HistoricalPage = new File(folderPath_HistoricalPage);
    	if (!folder_HistoricalPage.exists()) {
    		System.out.println( "Warn: There is no historical pages recorded!");
    		return null;
    	} else { 		
    		//	3.3.1	for each file in the historical folder
    		File[] fileList_HistoricalPage = folder_HistoricalPage.listFiles();
    		...
    		//	3.3.4	output the signal to screen
    		System.out.println( "Generated Tagged file: " + file_TaggedTargetPage.getAbsolutePath());
    		System.out.println( "Finish: " + file_TargetPage.getAbsolutePath());
    		return targetPage;
    	}	 	
	}
